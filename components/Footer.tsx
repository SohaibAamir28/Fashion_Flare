  ...
  return (
    <footer className="text-center h-16 sm:h-20 w-full sm:pt-2 pt-4 border-t mt-5 flex sm:flex-row flex-col justify-between items-center px-3 space-y-3 sm:mb-0 mb-3 border-gray-500">
      <div className="text-gray-500">
        Powered by Fashion_Flare
        
      </div>
      <div className="flex space-x-4 pb-4 sm:pb-0">
        <Link
          href="https://twitter.com/SohaibAamir4"
          className="group"
          aria-label="Sohaib on Twitter"
        >
          <svg
            aria-hidden="true"
        ...
        <Link
          href="https://github.com/SohaibAamir28/Fashion_Flare"
          className="group"
          aria-label="Sohaib on GitHub"
        >
          <svg
            aria-hidden="true"
            className="h-6 w-6 fill-gray-500 group-hover:fill-gray-300"
